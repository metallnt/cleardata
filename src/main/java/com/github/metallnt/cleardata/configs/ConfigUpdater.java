 ...
 * <p>
 * Date: 11.12.2021 10:48 11 12 2021
 *
 * @author Metall
 */
public class ConfigUpdater {

    public static void update(ClearData plugin, String resourceName, File toUpdate, List<String> ignoredSections) throws IOException {
